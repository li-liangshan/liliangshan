...
echo "WARNING, this script will delete the 'get-together' and the 'myindex' indics and re-index all data!"
echo "Press Control-C to cancel this operation."
echo
echo "Press [Enter] to continue."
read

# Delete the old index, swallow failure if it doesn't exist
...
echo
echo "Done creating 'get-togeter' index."
